...
INDEX_TICKER: str = '^HSI'                         # 指数：标普500 (^GSPC)；也可换成 ^HSI 等
ETF_TICKERS:  List[str] = ['2800.HK','2833.HK']   # ETF：美股/港股示例
START_DATE_STR = "1985-01-01"                       # 起始日期（会先裁剪到此日期）
...
# 输出图与表的文件名
FIG_PATH = DIR_OUT / "HSI_ETF_NAV_common_base.png"
TABLE_PATH = DIR_RAW / "HSI_ETF_NAV_for_plot.xlsx"
