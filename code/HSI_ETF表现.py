...
INDEX_TICKERS: List[str] = ['^HSI']
# ETF 清单
ETF_TICKERS:   List[str] = ['2800.HK','2833.HK','3037.HK']
TICKERS: List[str] = INDEX_TICKERS + ETF_TICKERS

# 周期来源 ，manual 是配置区指定list，table 是从本地表格解析
PERIOD_SOURCE: str = 'table'
# 市场周期表格路径
PERIODS_TABLE_PATH: str = 'data/HSI.xlsx'
# 指定 sheet
...
BRIEF_TXT = DIR_RAW / "HSI_brief.txt"
...
def main():
    ...
    if not metrics_df_cn.empty:
        ...
        for tk in TICKERS:
            ...
            # 把时间格式化成 YYYY-MM，用于“整体区间”一行，例如 1998-08 ～ 2025-11
